...
&nbsp
                ...
                <tr>
                    ...
                    <td>
                        <img alt="验证码" src="../valid.ashx" /><asp:CustomValidator ID="CustomValidator1" 
                            runat="server" ControlToValidate="tbValidate" ErrorMessage="验证码错误" 
...
&nbsp;</td>
                ...
                <tr id="SubmitAndReset">
                    <td>
                        <button type="submit" onclick="CustomValidator1_ServerValidate;">
